...
export interface CommonResult<T = any> {
  ...
  export interface ProposalApplicationRespVO {
    ...
    acceptanceType: ProposalApplicationType     // 申请类型
    applicationStatus: ProposalApplicationStatus // 申请状态
    expectedAcceptanceTime: string              // 预期开题时间
    ...
    acceptanceMaterialDOList?: AcceptanceMaterialDO[] // 开题申请材料列表
  }
  ...
  // 项目开题状态检查结果
  export interface ProjectAcceptanceStatusCheckResult {
  ...
  // 项目开题材料 Response VO
  export interface AcceptanceMaterialDO {
    id: number                                   // 主键ID
    projectId: number                            // 项目ID
  ...
  // 开题API响应类型
  export interface AcceptanceApiResponse<T = any> {
    code: number
    data: T
    msg: string
  }
  ...
  // 开题分页响应类型
  export interface AcceptancePageResponse<T = any> {
    code: number
    data: PageResult<T>
    msg: string
  }
  ...
  // ====== 接口别名（与后端验收命名保持一致，供页面按验收语义引用） ======
  // 验收申请
  export type AcceptanceApplicationRespVO = ProposalApplicationRespVO
  export type AcceptanceApplicationSaveReqVO = ProposalApplicationSaveReqVO
  export type AcceptanceApplicationPageReqVO = ProposalApplicationPageReqVO
  
  // 验收材料
  export type AcceptanceMaterialSaveReqVO = ProposalMaterialRewriteSaveReqVO
  export type AcceptanceMaterialReviewRespVO = ProposalMaterialReviewRewriteRespVO
  export type AcceptanceMaterialReviewSaveReqVO = ProposalMaterialReviewRewriteSaveReqVO
  
  // 验收会议
  export type AcceptanceMeetingRespVO = ProposalMeetingRewriteRespVO
  export type AcceptanceMeetingSaveReqVO = ProposalMeetingRewriteSaveReqVO
  export type AcceptanceMeetingParticipantReqVO = ProposalMeetingParticipantReqVO
  export type AcceptanceMeetingMaterialSaveReqVO = ProposalMeetingMaterialSaveReqVO
  
  // 验收结论
  export type AcceptanceConclusionRespVO = ProposalAcceptanceConclusionRespVO
  export type AcceptanceConclusionSaveReqVO = ProposalAcceptanceConclusionSaveReqVO
  
  // 验收整改
  export type AcceptanceRectificationRespVO = ProposalRectificationRewriteRespVO
  export type AcceptanceRectificationSaveReqVO = ProposalRectificationRewriteSaveReqVO
  
  // 验收时间线
  export type AcceptanceTimelineRespVO = ProposalTimelineRewriteRespVO
  export type AcceptanceTimelineSaveReqVO = ProposalTimelineRewriteSaveReqVO
  
  // 验收结论文件
  export type AcceptanceConclusionFileRespVO = ProposalConclusionFileRewriteRespVO
  export type AcceptanceConclusionFileSaveReqVO = ProposalConclusionFileRewriteSaveReqVO
  
  // 验收会议提醒
  export type AcceptanceMeetingRemindRespVO = ProposalMeetingRemindRespVO
  export type AcceptanceMeetingRemindSaveReqVO = ProposalMeetingRemindSaveReqVO
