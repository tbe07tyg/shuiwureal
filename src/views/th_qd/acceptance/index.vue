<!--
 * @file 项目验收管理页面
 * @description 包含申请管理、提交验收、管理中心、会议管理四个标签页
 * @author 科研管理系统
 * @version 1.0.0
 * @date 2025-01-22
-->
    ...
    <div class="acceptance-page">
      ...
      <div class="page-header">
        <div class="header-content">
          ...
          <p class="page-description">管理项目验收相关材料、流程的各项、确保项目验收顺利进行</p>
        </div>
      </div>
...
.acceptance-tabs :deep(.ant-tabs-nav) {
    margin: 0;
  padding-top: 2px;
  padding-left: 4px;
  padding-bottom: 2px;
...
.acceptance-tabs :deep(.ant-tabs-tab) {
    padding: 12px 24px;
  font-size: 14px;
  border-radius: 10px;
...
.acceptance-tabs :deep(.ant-tabs-tab-active) {
  background: white;
  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);
}

.acceptance-tabs :deep(.ant-tabs-tab:not(.ant-tabs-tab-active):hover) {
...
.acceptance-tabs :deep(.ant-tabs-tab:not(.ant-tabs-tab-active) .anticon) {
  color: #8c8c8c;
}

.acceptance-tabs :deep(.ant-tabs-tab-active .anticon) {
  color: #1890ff;
}

/* 标签页切换动画 */
.acceptance-tabs :deep(.ant-tabs-content) {
  border: none;
  background: transparent;
  transition: all 0.3s ease;
}

.acceptance-tabs :deep(.ant-tabs-ink-bar) {
  display: none;
}
...
/* 确保内容区域占满高度 */
.acceptance-tabs :deep(.ant-tabs-tabpane-active) {
  height: 100%;
}
...
/* 添加加载动画 */
.acceptance-tabs :deep(.ant-tabs-tabpane) {
